      ...
      try {
        ...
        const responses = await Promise.all(
          platforms.map(platform =>
            fetch(`https://clist.by/api/v1/contest/?api_key=${import.meta.env.VITE_API_KEY}&resource__id=${platform.id}&end__gt=${currentDate}&username=${import.meta.env.VITE_USERNAME}`)
          )
        );
